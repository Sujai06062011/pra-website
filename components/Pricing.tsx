...
const PLANS = [
  {
    ...
    features: [
      { text: "WhatsApp booking (up to 100 patients/month)", included: true },
      { text: "Live queue management", included: true },
      { text: "Basic prescription", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Lab reports", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Multi-staff access (up to 5)", included: true },
      { text: "Multi-location support", included: true },
      { text: "Custom WhatsApp number branding", included: true },
